        ...
        <section className="bg-background overflow-hidden">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto gap-8 lg:py-16 lg:grid-cols-12 overflow-hidden">
                <div className="mr-auto place-self-center lg:col-span-7 text-center lg:text-left px-4">
                    ...
                    <p className="max-w-2xl mb-6 font-light text-gray-400 lg:mb-8 md:text-lg lg:text-xl">   {t('hero.description')}</p>
                    ...
                    <div className="w-full aspect-video max-w-lg lg:max-w-full flex justify-center items-center min-w-[200px]">
                        {i18n.language === 'bg' ? (
                            <iframe
                                ...
                                allowFullScreen
                                title="Video BG"
                                className="p-4 border-2 border-white border-solid rounded"
